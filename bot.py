...
def keygen(length=32, alphabet=r'AaBbCcDdEeFfGgHhIiJjKkLlMmNnOo'
...
with [[InlineKeyboardButton('Generate', callback_data='generate keys')]] as bs:
    button_markup = InlineKeyboardMarkup(bs)
